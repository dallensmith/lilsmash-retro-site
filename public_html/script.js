    ...
    function setupVisualizer() {
        ...
        function draw() {
            ...
            for (let i = 0; i < bufferLength; i++) {
                ...
                const normalizedHeight = (barHeight / maxHeight) * canvas.height;
                const limitedHeight = Math.min(normalizedHeight, canvas.height);
        
                ctx.fillRect(x, canvas.height - limitedHeight, barWidth, limitedHeight);
                ctx.fillRect(canvas.width - x - barWidth, canvas.height - limitedHeight, barWidth, limitedHeight);
                x += barWidth + 1;
            }
        }
